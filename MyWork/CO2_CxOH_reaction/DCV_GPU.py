            ...
            if method_type == regression_model_method_normals:
                ...
                #                    return 1.0 - r2
                            ...
                            # TPFN
                                ...
                                regression_model = AutoTabPFNRegressor(device='cuda') # TPFN モデルの宣言
                    ...
                    DCV_values.to_csv(f'{savedir}/{y_name}/prediction_accuracy/{x_name}_prediction_accuracy_gpu.csv') # 評価指標を保存
