...
def dcv_analysis():
    ...
    #regression_model_method_normals = ['RF','XGB','LGB','GPR_1']
    ...
    for x_name in x_names:
        ...
        data =  pd.read_csv(f'MyWork/datasets/larger_data/data_for_article/{x_name}.csv', index_col=0) # データの読み込み
            ...
            if method_type == regression_model_method_normals:
                ...
                #                    return 1.0 - r2
                            ...
                            # TPFN
                                ...
                                regression_model = TabPFNRegressor() # TPFN モデルの宣言
